...
executable   = /afs/cern.ch/user/v/valcayne/Workspace/2024_MAREX/Analysis_MAREX/Make2DHistos/Make2DHistos
arguments    = $(run)
...
queue run from /afs/cern.ch/user/v/valcayne/Workspace/2024_MAREX/Analysis_MAREX/Make2DHistos/Condor/Inputs/ArgumentsForCondor2DHisto.txt
