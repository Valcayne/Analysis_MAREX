...
void plot01(const char* RunDescriptor,const char* DetName,int DetID1,int DetID2,int DetID3,int DetID4,const char* savefname=0){
  ...
  TGraph* gr1=GetGainMonitoring(DetName,DetID1,dirname,RunDescriptor);
  TGraph* gr2=0; if(DetID2>=0){gr2=GetGainMonitoring(DetName,DetID2,dirname,RunDescriptor);}
  TGraph* gr3=0; if(DetID3>=0){gr3=GetGainMonitoring(DetName,DetID3,dirname,RunDescriptor);}
  TGraph* gr4=0; if(DetID4>=0){gr4=GetGainMonitoring(DetName,DetID4,dirname,RunDescriptor);}
